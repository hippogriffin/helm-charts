...
and its [`values.yaml`](https://github.com/hippogriffin/helm-charts/tree/main/charts/library/common/values.yaml) for
...
application. For more deployment examples, check out the [`examples` folder](https://github.com/hippogriffin/helm-charts/tree/main/examples/).
...
[here](https://github.com/hippogriffin/helm-charts/tree/main/charts/other/app-template).
